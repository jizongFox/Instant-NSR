...
def get_encoder(encoding, input_dim=3,
                multires=6,
                degree=4,
                num_levels=16, level_dim=2, base_resolution=16, per_level_scale=1.3819, log2_hashmap_size=19,
    ...
    if encoding == 'None':
        ...
        encoder = HashEncoder(input_dim=input_dim, num_levels=num_levels, level_dim=level_dim,
                              per_level_scale=per_level_scale, base_resolution=base_resolution,
